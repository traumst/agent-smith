...
2. **Versatility**: The core logic resides in pure Go packages (`internal/agent`) fully decoupled from the API or UI. The module is `smithai` — importable directly for IDE/TUI integration.
